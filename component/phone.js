document.write(
  ...
  <div class="icon-clock vertical-align"> 
    <div class="clock ball pink extra-big scale-animation delay-730"></div>
  ...
  <div class="icon-sun vertical-align">
    <div class="sun-cloud">
      <div class="sun sun-animation delay-830">
        <div class="sun-lines first yellow"></div>
        <div class="sun-lines second yellow"></div>
        <div class="sun-lines third yellow"></div>
        <div class="sun-lines fourth yellow"></div>
      </div>
      <div class="cloud cloud-animation delay-830">
        <div class="cloud-element light-blue ball first"></div>
        <div class="cloud-element light-blue ball second"></div>
        <div class="cloud-element light-blue ball third"></div>
        <div class="cloud-element light-blue ball fourth"></div>
      </div>
    </div>
...
<div class="icons-right">
  <div class="hamburger opacity delay-830">
    <div class="hamburger-top dark-orange">
      <div class="pointer white ball"></div>
      <div class="pointer white ball"></div>
      <div class="pointer white ball"></div>
      <div class="pointer white ball"></div>
      <div class="pointer white ball"></div>
    </div>
    <div class="hamburger-middle orange"></div>
    <div class="hamburger-bottom dark-orange"></div>
  </div>
  ...
  <div class="tree opacity delay-1030">
    <div class="tree-top light-green"></div>
    <div class="tree-bottom brown"></div>
  </div>
  ...
  <div class="boat opacity delay-1130">
    <div class="boat-icon dark-blue">
      <div class="boat-sail dark-blue"></div>
    </div>
    <style>
    :root {
  /* colors */
...
/* sizes */
.extra-big {
  height: var(--extra-bigSize);
  width: var(--extra-bigSize);
}

.medium-big {
  height: var(--medium-bigSize);
  width: var(--medium-bigSize);
}
...
.extra-small {
  height: var(--extra-smallSize);
  width: var(--extra-smallSize);
}
...
.center-element:nth-child(1) {
  margin-left: -55px;
  margin-top: -55px;  
}

.center-element:nth-child(2) {
  margin-left: -48px;
  margin-top: -48px;  
}

.center-element:nth-child(3) {
  margin-left: -41px;
  margin-top: -41px;  
}

.center-element:nth-child(4) {
  margin-left: -25px;
  margin-top: -25px;
  transform: none;
}

.center-element:nth-child(5) {
...
.icon-clock .clock {
  height: calc(var(--extra-bigSize) + 4px);
  width: calc(var(--extra-bigSize) + 4px);
  position: relative;
  margin-right: 20px;
  opacity: 1;
}

.icon-clock .clock:before,
.icon-clock .clock:after {
  content: '';
  position: absolute;
  width: 2px;
  height: 14px;
...
.icon-clock .clock:after {
  ...
  margin-left: 0;
  height: 2px;
  animation: rotateMinutes 330ms linear 530ms;
  animation-fill-mode: both;
}

.icon-clock .clock.start:after {
  animation: runningRotateMinutes 6000ms linear infinite;  
}

.icon-clock .dashed-pink {
  width: 210px;
  border: 1px dashed var(--pink);
  margin-left: 10px;
  position: relative;
  animation: pinkScale 1200ms cubic-bezier(0, 1, 0.25, 1) 830ms;
  animation-fill-mode: both;
}

.icon-clock .dashed-pink .extra-small {
  left: 42px;
  bottom: -10px
}

.icon-clock .dashed-pink .small {
  left: 130px;
  bottom: 8px
}
...
.sun {
  width: calc(var(--extra-bigSize) + 6px);
  height: calc(var(--extra-bigSize) + 6px);
  position: relative;
  margin-right: 20px;
}
...
.sun:after {
  content: '';
  width: calc(var(--extra-bigSize) - 14px);
  height: calc(var(--extra-bigSize) - 14px); 
  position: absolute;
  top: 6px;
  left: 6px;
  background-color: var(--yellow);
...
.icon-sun .dashed-yellow {
  width: 85px;
  border: 1px dashed var(--yellow);
  margin-left: 10px;
  position: relative;
  animation: pinkYellow 1200ms cubic-bezier(0, 1, 0.25, 1) 930ms;
  animation-fill-mode: both;
}

.icon-sun .dashed-yellow .extra-small {
    left: 25px;
    bottom: 6px;
}

.icon-sun .dashed-yellow .small {
    left: 42px;
    bottom: -12px;
}
...
.icon-sun .arrow:before,
.icon-sun .arrow:after {
  content: '';
  width: 2px;
  height: 8px;
  background-color: var(--yellow);
...
.marker .top {
  width: calc(var(--bigSize) + 18px);
  height: calc(var(--bigSize) + 18px);
}
...
.icon-marker .dashed-red {
  width: 208px;
  border: 1px dashed var(--red);
  margin-left: 10px;
  position: relative;
  animation: pinkRed 1200ms cubic-bezier(0, 1, 0.25, 1) 1030ms;
  animation-fill-mode: both;
}

.icon-marker .dashed-red .small {
    left: 40px;
    bottom: 6px;
}

.icon-marker .dashed-red .ball:nth-child(2) {
  left: 100px;
  bottom: -14px;
}

.icon-marker .dashed-red .ball:nth-child(3) {
  left: 132px;
  bottom: 8px;
}
...
.icon-marker .arrow:before,
.icon-marker .arrow:after {
  content: '';
  width: 2px;
  height: 8px;
  background-color: var(--red);
...
.scale-animation {
  animation: scale 650ms cubic-bezier(0, 1.3, 0.2, 1.25);
  animation-fill-mode: both;
}

.reverse-scale-animation {
  animation: reverseScale 650ms cubic-bezier(0, 1.3, 0.2, 1.25);
  animation-fill-mode: both;
}

.phone-scale-animation {
  animation: phoneScale 600ms cubic-bezier(0, 0.86, 0.25, 1);
  animation-fill-mode: both;
}

.sun-animation {
  animation: sunAnimation 740ms cubic-bezier(0, 1, 0.65, 1);
  animation-fill-mode: both;
}

.sun.start {
  animation: runningRotate 6000ms linear infinite;
  animation-fill-mode: both;
}

.cloud-animation {
  animation: cloudAnimation 860ms cubic-bezier(0, 1, 0.25, 1);
  animation-fill-mode: both;
}

.marker-animation {
  animation: markerAnimation 760ms cubic-bezier(0, 1, 0.25, 1.65);
  animation-fill-mode: both;
}

.marker.start {
  animation: runningMarkerAnimation 2300ms linear infinite;
  animation-fill-mode: both;
  transform-origin: bottom;
}

.start .rotate {
  animation: rotate 2130ms linear infinite;
  animation-fill-mode: both;
}

.opacity {
  animation: opacity 630ms linear;
  animation-fill-mode: both;
}
...
@keyframes phoneScale {
  0% {
    transform: scale(0.3) translateZ(0) translateY(470px);
    opacity: 0;
  }
...
@keyframes sunAnimation {
  0% {
    transform: translateX(6px) translateY(12px) translateZ(0);
    opacity: 0;
  }
...
@keyframes cloudAnimation {
  0% {
    transform: translateX(18px) translateY(0) translateZ(0);
    opacity: 0;
  }
...
@keyframes runningMarkerAnimation {
  0% {
...
@keyframes runningRotateMinutes {
  0% {
    transform: rotate(35deg) translateZ(0);
  }
  
  100% {
    transform: rotate(395deg) translateZ(0);
  }
}
...
@keyframes pinkRed {
  ...
  100% {
    ...
    <div class="sea-icon">
      ...
      <div class="sea-line middle"></div>
      <div class="sea-line middle"></div>
      <div class="sea-line middle"></div>
      <div class="sea-line last"></div>
    </div>
    <div class="sea-icon">
      <div class="sea-line"></div>
      <div class="sea-line middle"></div>
  ...
  <div class="notification light-grey opacity delay-1230">
    <div class="top-notification">
      <div class="icon-notification red"></div>
      <div class="title-notification white"></div>
    </div>
